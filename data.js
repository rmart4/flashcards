...
// Chaque chapitre contient deux jeux de contenu :
...
const CHAPTERS = [
  ...
  },
  {
    ...
    qcm: [
      ...
      { q: "Quel est l'énoncé correct du théorème de l'énergie mécanique (TEM) ?", options: ["ΔEm = ΣWAB(forces non conservatives)", "ΔEm = ΣWAB(toutes les forces)", "ΔEm = ΣWAB(forces conservatives)", "ΔEm est toujours nulle"] },
  ...
  },
  {
    ...
    cards: [
      ...
      { q: "Énoncer la loi qualitative reliant Δv et ΣF (référentiel galiléen).", a: "La variation du vecteur vitesse d'un système est colinéaire à la résultante des forces appliquées ΣF, et de même sens." },
    ...
    qcm: [
      ...
      { q: "La loi qualitative reliant Δv et ΣF énonce que Δv est...", options: ["colinéaire à ΣF, et de même sens", "colinéaire à ΣF, de sens opposé", "perpendiculaire à ΣF", "indépendant de ΣF"] },
  ...
  },
  {
    ...
    qcm: [
      ...
      { q: "Quel est l'énoncé correct du théorème de l'énergie cinétique ?", options: ["ΔEc = ΣWAB(forces extérieures)", "ΔEc = ΣWAB(forces conservatives uniquement)", "ΔEc est toujours nulle", "ΔEc = ΣWAB(forces non conservatives uniquement)"] },
